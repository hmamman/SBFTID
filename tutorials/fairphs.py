...
class FairPHS(FairSES):
    def __init__(self, config, model, sensitive_param, population_size=200, selection_strategy='teo', feature_size_rate=10, alpha=0.7, threshold=0):
        super().__init__(config, model, sensitive_param, population_size, threshold)
        self.approach_name = f"FairPHS_Tuned_{selection_strategy}"
